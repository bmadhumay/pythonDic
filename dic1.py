...
#dest_pic.pack()
dest_pic.place(relx=0, rely=0, relheight=0.1,relwidth=1)

a = StringVar()
word_1 = Entry(root, textvariabl = a, background = "blue", fg = "white", font =  ('arial',10,"bold"))
word_1.place(relx=0.185, rely=0.70, relheight=0.082)

button_1 = Button(root, text="Search The Word...", command = lambda:search_word(a.get()), background = "red", fg = "white", font = ("arial",10,"bold"))
button_1.place(relx=0.25, rely=0.85, relheight=0.052)

meaning_word = Text(root, background = "white", font = ('arial',10,"bold"))
